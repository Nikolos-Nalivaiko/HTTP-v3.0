        ...
        <main class="main">
            <section class="no-access main__section-page __left-container">
                <div class="no-access__text">
                    ...
                    <p class="no-access__description">Авторизація дозволить вам користуватися всіма перевагами нашої платформи
                        та мати можливість налаштувати персоналізовані параметри.</p>
                    <a href="sign-in.php" class="no-access__btn">Увійти</a> 
                    <a href="select.php" class="no-access__btn">Створити профіль</a>   
                </div>
                <img src="../img/403.svg">
            </section>
        </main>
